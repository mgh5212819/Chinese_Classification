...
class Models(object):
    ...
    def feature_engineer(self):
        ...
        ### TODO
        # 1. 获取 lda feature
        #train['bow'] = train["queryCutRMStopWords"].apply(lambda x: self.ml_data.em.lda.id2word.doc2bow(x))
        #test['bow'] = test["queryCutRMStopWords"].apply(lambda x: self.ml_data.em.lda.id2word.doc2bow(x))
        ...
        #train_ae = get_autoencoder_feature(train, self.ml_data.em.ae.max_features, self.ml_data.em.ae.max_len, self.ml_data.em.ae.model,
        #                                  tokenizer= self.ml_data.em.ae.tokenizer)
        #test_ae = get_autoencoder_feature(test, self.ml_data.em.ae.max_features, self.ml_data.em.ae.max_len, self.ml_data.em.ae.model,
        #                                  tokenizer= self.ml_data.em.ae.tokenizer)
